...
\begin{figure}[h]
    \centering
    \includegraphics[width=12cm,keepaspectratio]{img/react_tree.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=14cm,keepaspectratio]{img/mavlink_seq.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{img/fsm.png}
