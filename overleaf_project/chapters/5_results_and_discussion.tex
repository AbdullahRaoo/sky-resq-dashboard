...
\begin{figure}[htp]
    \centering
    \includegraphics[width=14cm,keepaspectratio]{img/main_dashboard.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/ipc.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=12cm,keepaspectratio]{img/electron_native.png}
